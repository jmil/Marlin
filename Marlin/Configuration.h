...
#define STRING_VERSION_CONFIG_H "2012-07-18" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "jmil_Hive_Komodo_with_RAMPS_1.4" //Who made the changes.
...
//SLOATEBOT
#define DEFAULT_MAX_ACCELERATION      {500,500,100,500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
