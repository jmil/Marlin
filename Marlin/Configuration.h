...
#define STRING_VERSION_CONFIG_H "2012-03-13" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "jmil_ChenLab" //Who made the changes.
